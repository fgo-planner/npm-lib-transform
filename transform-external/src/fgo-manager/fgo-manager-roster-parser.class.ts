import { Immutable, ImmutableRecord, ReadonlyRecord } from '@fgo-planner/common-types';
...
import { MasterServantUpdateIndeterminate as Indeterminate, MasterServantUpdateIndeterminateValue as IndeterminateValue, NewMasterServantUpdate } from '@fgo-planner/transform-types';
...
export class FgoManagerRosterParser {
    ...
    constructor(
        ...
        private _logger?: BaseLogger<number>
    ) {
